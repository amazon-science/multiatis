...
fh = logging.FileHandler(os.path.join(model_dir, 'lstm.' + str(random_seed) + '.log'), mode='w')
...
for lang in ['EN', 'ES', 'DE', 'ZH', 'JA', 'PT', 'FR', 'HI', 'TR']:
    ...
    model_name = 'model_lstm_' + lang + '.' + str(random_seed)
    if lang == 'EN':
        train_input = data_dir + 'atis_train.tsv'
...
for lang in ['EN', 'ES', 'DE', 'ZH', 'JA', 'PT', 'FR', 'HI', 'TR']:
    log.info('Evaluate on %s:' % lang)
    model_name = 'model_lstm_' + src_lang + '.' + str(random_seed)
    if lang == 'EN':
        test_input = data_dir + 'atis_test.tsv'
    else:
        test_input = data_dir + 'atis_test_' + lang + '.tsv'
