...
fh = logging.FileHandler(os.path.join(model_dir, 'lstm_mt.' + str(random_seed) + '.log'), mode='w')
...
for lang in ['ES', 'DE', 'ZH', 'JA', 'PT', 'FR', 'HI', 'TR']:
    ...
    model_name = 'model_lstm_mt_' + lang + '.' + str(random_seed)
    train_input = data_dir + 'train_translated_' + lang + '.tsv'
